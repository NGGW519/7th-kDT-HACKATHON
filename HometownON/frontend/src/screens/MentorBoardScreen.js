...
const MentorBoardScreen = ({ navigation }) => {
  ...
  const renderPost = ({ item }) => (
    <TouchableOpacity 
      ...
      onPress={() => navigation.navigate('MentorBoardDetail', { post: item })}
    >
      ...
      <View style={styles.actionButtons}>
        <TouchableOpacity 
          ...
          onPress={() => navigation.navigate('MentorDetail', { post: item })}
        >
          <Text style={[
    ...
    <SafeAreaView style={styles.container}>
      ...
      <SafeAreaView style={styles.headerSafeArea}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>멘토게시판</Text>
          <TouchableOpacity 
            style={styles.writeButton}
            onPress={() => navigation.navigate('MentorSeekingWrite')}
          >
