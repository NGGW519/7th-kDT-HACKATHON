...
export default function MentorMyPageScreen() {
    ...
    <SafeAreaView style={styles.safe}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.menuSection}>
          ...
          <TouchableOpacity style={styles.menuItem} onPress={() => navigation.navigate('MentorSettingsScreen')}>
            <Text style={styles.menuIcon}>⚙️</Text>
            <Text style={styles.menuText}>설정</Text>
            <Text style={styles.menuArrow}>›</Text>
          </TouchableOpacity>

          <TouchableOpacity style={styles.menuItem} onPress={() => navigation.navigate('MentorHelp')}>
            <Text style={styles.menuIcon}>❓</Text>
