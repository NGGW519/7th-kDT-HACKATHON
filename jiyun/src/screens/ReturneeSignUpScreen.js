    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <ScrollView style={styles.scrollContainer} showsVerticalScrollIndicator={false}>
          ...
          {/* Career Type Section */}
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>4. 커리어 유형 선택 *</Text>
          ...
          {/* Personality Section */}
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>5. 나의 성향 및 기대</Text>
            <TextInput
